...
urlpatterns = [
    ...
    path('main-page/relaxation_techniques1.html', user_views.reltech1, name='relaxation_techniques'),
    path('main-page/relaxation_techniques.html', user_views.reltech2, name='relaxation_techniques'),
    path('main-page/relaxation_techniques2.html', user_views.reltech3, name='relaxation_techniques'),
]